...
import com.fitcrew.FitCrewAppTrainers.converter.RatingTrainerDocumentRatingTrainerModelConverterImpl;
...
import com.fitcrew.FitCrewAppTrainers.service.client.rating.TrainerRatingService;
...
class TrainerRatingServiceTest {
    ...
    private RatingTrainerDocumentRatingTrainerModelConverter ratingTrainerConverter = new RatingTrainerDocumentRatingTrainerModelConverterImpl();
    ...
    void shouldSetRateForTheTrainer() {
        ...
        Either<ErrorMsg, RatingTrainerModel> ratedTrainer =
    ...
    void shouldNotSetRateForTheTrainer() {
        ...
        Either<ErrorMsg, RatingTrainerModel> noRatedTrainer =
                trainerRatingService.setRateForTheTrainer(TRAINER_DOCUMENT_EMAIL, "5");
